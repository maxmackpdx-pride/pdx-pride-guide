...
(function () {
  ...
  const EVENTS = [
    ...
    { id: 13, day: "THU", date: "Jul 16", hour: "8:00", ampm: "PM",
      title: "Sasha Colby Pride Kick-Off", venue: "Star Theater", neighborhood: "Old Town",
    ...
    { id: 53, day: "THU", date: "Jul 16", hour: "7:00", ampm: "PM",
      title: "Sad Girl Summer, Pride Edition", venue: "Black Water", neighborhood: "NE Portland",
    ...
    { id: 17, day: "THU", date: "Jul 16", hour: "7:05", ampm: "PM",
      title: "Portland Pickles Pride Night", venue: "Walker Stadium", neighborhood: "SE Portland",
    ...
    { id: 51, day: "FRI", date: "Jul 17", hour: "5:00", ampm: "PM",
      title: "Midtown Beer Garden Pride", venue: "Midtown Beer Garden", neighborhood: "Downtown",
    ...
    { id: 15, day: "FRI", date: "Jul 17", hour: "9:00", ampm: "PM",
      title: "Bearracuda Pride Friday: Vaseline Alley", venue: "722 E Burnside", neighborhood: "Inner East",
    ...
    { id: 1, day: "SAT", date: "Jul 18", hour: "12:00", ampm: "PM",
      title: "Portland Pride Waterfront Festival", venue: "Tom McCall Waterfront Park", neighborhood: "Downtown",
    ...
    { id: 47, day: "SAT", date: "Jul 18", hour: "5:00", ampm: "PM",
      title: "Dyke March Portland Pride", venue: "Downtown Portland", neighborhood: "Downtown",
    ...
    { id: 2, day: "SUN", date: "Jul 19", hour: "11:00", ampm: "AM",
      title: "Portland Pride Parade", venue: "North Park Blocks to Naito Pkwy", neighborhood: "Downtown",
    ...
    { id: 35, day: "SUN", date: "Jul 19", hour: "2:00", ampm: "PM",
      title: "Portland Trans Pride March", venue: "North Park Blocks", neighborhood: "Downtown",
      admission: "FREE", tags: ["March", "All Ages"],
      blurb: "Free, all ages, masks encouraged. Organized by and for the trans community." },
    { id: 21, day: "SUN", date: "Jul 19", hour: "1:00", ampm: "PM",
      title: "The Sports Bra Pride Block Party", venue: "The Sports Bra", neighborhood: "NE Portland",
    ...
    { id: 26, day: "SUN", date: "Jul 19", hour: "7:00", ampm: "PM",
      title: "Chai & Roses Pride Party", venue: "Holocene", neighborhood: "SE Portland",
  ...
  const PLACES = [
    ...
    { name: "Jackie's", category: "bars", address: "930 SE Sandy Blvd",
      ...
      events: [{ day: "SUN", date: "Sun, Jul 19 · 3:00 PM", title: "Lumbertwink Plaid Patio Pride" }] },
    ...
    { name: "Sanctuary Club", category: "venues", address: "33 NW 9th Ave",
      ...
      events: [{ day: "SAT", date: "Sat, Jul 18 · 9:00 PM", title: "Stank Yes Coach, PDX PRIDE" }] },
  ...
  window.PDX_DATA = { EVENTS, DAYS, PLACES, PLACE_CATEGORIES, COMMUNITY };
})();
