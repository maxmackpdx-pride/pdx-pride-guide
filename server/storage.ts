...
function seedData() {
  ...
  if (existing.length > 0) {
    const needsReseed = OLD_SEED_TITLES.includes(existing[0].title) || existing[0].lat === null || existing[0].posterImageUrl === null || existing.length < 46;
    if (needsReseed) {
  ...
  const seedEvents = [
    ...
    },
    {
      ...
      address: "1215 NW 23rd Ave, Portland, OR 97210",
    ...
    },
    {
      ...
      dateStart: "2026-07-16T19:00:00", dateEnd: "2026-07-16T22:00:00",
      dayOfWeek: "THU",
      ageRequirement: "ALL_AGES",
    ...
    },
    {
      ...
      dateStart: "2026-07-18T11:00:00", dateEnd: "2026-07-19T15:00:00",
      dayOfWeek: "SAT",
      ageRequirement: "ALL_AGES",
    ...
    {
      title: "Twirl! PDX Queer Disco — Pride Edition",
    ...
    },
    {
      ...
      neighborhood: "Portland",
      lat: 45.5231, lng: -122.6765,
      dateStart: "2026-07-20T19:00:00", dateEnd: "2026-07-20T23:00:00",
      dayOfWeek: "MON",
      ageRequirement: "ALL_AGES",
      eventTypes: JSON.stringify(["PARTY", "DANCE", "QTBIPOC"]),
      admission: "TICKETED",
      ticketUrl: "https://www.etix.com/ticket/p/68162712",
      isPublic: true, isPrivate: false, isHouseParty: false, isSexPositive: false, nudityOk: false,
      posterImageUrl: null, status: "LIVE", source: "admin_seeded", isClaimable: true,
      claimedBy: null, submittedBy: null, adminNotes: null, createdAt: now,
    },
    ...
    },
    {
      ...
      dateStart: "2026-07-17T20:00:00", dateEnd: "2026-07-17T22:00:00",
      dayOfWeek: "FRI",
      ageRequirement: "ALL_AGES",
      eventTypes: JSON.stringify(["COMMUNITY", "FREE", "OUTDOOR"]),
      admission: "FREE",
      ticketUrl: null,
      isPublic: true, isPrivate: false, isHouseParty: false, isSexPositive: false, nudityOk: false,
      posterImageUrl: null, status: "LIVE", source: "admin_seeded", isClaimable: true,
    ...
    },
    {
      ...
      dayOfWeek: "SUN",
      ageRequirement: "ALL_AGES",
      eventTypes: JSON.stringify(["MARCH", "COMMUNITY", "FREE"]),
      admission: "FREE",
    ...
    },
    {
      ...
      description: "Sabrina the Teenage Witch 30th anniversary celebration with cast members. Drag performances and nostalgia.",
    ...
    },
    {
      ...
      description: "Pride drag show at Escape Bar & Grill.",
    ...
    },
    {
      ...
      description: "Late night/early morning queer dance party at REALM PDX.",
      venueName: "REALM PDX",
      address: "Portland, OR",
      neighborhood: "Portland",
      lat: 45.5231, lng: -122.6765,
      ...
      dayOfWeek: "SAT",
      ageRequirement: "21_PLUS",
      eventTypes: JSON.stringify(["PARTY", "DANCE", "LATE-NIGHT"]),
      admission: "TICKETED",
      ticketUrl: null,
      isPublic: true, isPrivate: false, isHouseParty: false, isSexPositive: false, nudityOk: false,
      posterImageUrl: null, status: "LIVE", source: "admin_seeded", isClaimable: true,
    ...
    },
    {
      ...
      dayOfWeek: "SAT",
      ageRequirement: "ALL_AGES",
      eventTypes: JSON.stringify(["FESTIVAL", "COMMUNITY", "FREE"]),
      admission: "FREE",
      ticketUrl: null,
      isPublic: true, isPrivate: false, isHouseParty: false, isSexPositive: false, nudityOk: false,
      posterImageUrl: null, status: "LIVE", source: "admin_seeded", isClaimable: true,
    ...
    },
    {
      ...
      dayOfWeek: "SUN",
      ageRequirement: "21_PLUS",
      eventTypes: JSON.stringify(["PARTY", "COMMUNITY"]),
      admission: "TICKETED",
      ticketUrl: null,
      isPublic: true, isPrivate: false, isHouseParty: false, isSexPositive: false, nudityOk: false,
      posterImageUrl: null, status: "LIVE", source: "admin_seeded", isClaimable: true,
    ...
    },
    {
      ...
      neighborhood: "Old Town",
      lat: 45.5249, lng: -122.6742,
      dateStart: "2026-07-18T20:00:00", dateEnd: "2026-07-18T23:59:00",
      dayOfWeek: "SAT",
      ageRequirement: "21_PLUS",
    ...
    },
    {
      ...
      neighborhood: "Old Town",
      lat: 45.5228, lng: -122.6716,
      dateStart: "2026-07-19T12:00:00", dateEnd: "2026-07-19T22:00:00",
      dayOfWeek: "SUN",
      ageRequirement: "ALL_AGES",
      eventTypes: JSON.stringify(["BLOCK-PARTY", "OFFICIAL", "FREE", "OUTDOOR"]),
      admission: "FREE",
