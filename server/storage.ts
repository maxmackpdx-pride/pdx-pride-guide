...
function seedData() {
  ...
  if (existing.length > 0) {
    const needsReseed = OLD_SEED_TITLES.includes(existing[0].title) || existing[0].lat === null || existing[0].posterImageUrl === null || existing.length < 35;
    if (needsReseed) {
  ...
  const seedEvents = [
    ...
    },
    {
      ...
      description: "Pride Sunday afternoon patio party at Jackie's. Plaid-themed. DJs Not That Jennifer & Orographic. Sexy lumber go-gos gyrating, photo booth by Matty Hoffman. Discounted entry for those wearing plaid. 2 patios, 2 bars, air-conditioned indoors, VIP area.",
      venueName: "Jackie's",
      address: "930 SE Sandy Blvd, Portland, OR 97214",
      neighborhood: "SE Portland",
      lat: 45.5192, lng: -122.6478,
      dateStart: "2026-07-20T15:00:00", dateEnd: "2026-07-20T21:00:00",
      dayOfWeek: "MON",
      ageRequirement: "21_PLUS",
    ...
    },
    {
      ...
      description: "Bearracuda's Pride Thursday kick-off at 722 E Burnside. Theme: VASELINE ALLEY. Harnesses, jockstraps, and fetish gear encouraged. DJs Matt Consola (PDX) + Cactuhead (UK). Hosted by Matt Bearracuda & JP Hardy. Venmo tickets at will call.",
  ...
  for (let eventId = 1; eventId <= 35; eventId++) {
