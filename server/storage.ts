...
function seedData() {
  ...
  if (existing.length > 0) {
    const needsReseed = OLD_SEED_TITLES.includes(existing[0].title) || existing[0].lat === null || existing[0].posterImageUrl === null || existing.length < 46 || (existing[0].ticketUrl === "https://pridenw.org" && existing[0].title === "Portland Pride Waterfront Festival");
    if (needsReseed) {
  ...
  const seedEvents = [
    ...
    },
    {
      ...
      dateStart: "2026-07-18T17:15:00", dateEnd: "2026-07-18T20:30:00",
      dayOfWeek: "SAT",
      ageRequirement: "ALL_AGES",
    ...
    },
    {
      ...
      admission: "TICKETED",
      ticketUrl: "https://yescoachparty.com/events",
    ...
    },
    {
      ...
      admission: "TICKETED",
      ticketUrl: "https://www.vividseats.com/a-spellman-spectacle-tickets--theater-arts-and-theater/performer/536349",
      isPublic: true, isPrivate: false, isHouseParty: false, isSexPositive: false, nudityOk: false,
      posterImageUrl: null, status: "LIVE", source: "admin_seeded", isClaimable: true,
      claimedBy: null, submittedBy: null, adminNotes: null, createdAt: now,
    },
    ...
    },
    {
      ...
      admission: "FREE",
      ticketUrl: "https://www.oraflcio.org",
      isPublic: true, isPrivate: false, isHouseParty: false, isSexPositive: false, nudityOk: false,
      posterImageUrl: null, status: "LIVE", source: "admin_seeded", isClaimable: true,
      claimedBy: null, submittedBy: null, adminNotes: null, createdAt: now,
    },
