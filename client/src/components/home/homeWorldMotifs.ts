...
export const WORLD_MOTIFS: Partial<Record<WorldKey, WorldMotif[]>> = {
  outz: [
    { path: "M12 52 L32 20 L52 52 Z M20 52 L32 32 L44 52", top: "8%", left: "58%", size: "120px", opacity: 0.22, rotate: "-6deg" },
    { path: "M32 46 L18 22 L46 22 Z M18 46 L46 46", top: "42%", left: "4%", size: "64px", opacity: 0.18, rotate: "4deg" },
    { path: "M32 12 V30 M22 30 Q32 20 42 30 Q46 40 32 46 Q18 40 22 30", top: "65%", left: "70%", size: "90px", opacity: 0.16, rotate: "10deg" },
    { path: "M12 40 L32 14 L52 40 M20 40 L20 52 M44 40 L44 52 M20 52 H44", top: "4%", left: "10%", size: "46px", opacity: 0.2, rotate: "-3deg" },
  ],
  placez: [
