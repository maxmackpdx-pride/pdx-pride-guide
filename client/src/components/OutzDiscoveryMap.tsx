...
export default function OutzDiscoveryMap({points,selected,onSelect,focusId}:Props){return <MapContainer center={[45.52,-120.65]} zoom={6} zoomSnap={0.25} scrollWheelZoom={true} touchZoom={true} style={{height:'100%',width:'100%',background:'#050506'}}><CartoVectorBasemap waterColor="#385866"/><Frame points={points} selected={selected} focusId={focusId}/><Waypoints points={points} selected={selected} onSelect={onSelect}/></MapContainer>}
