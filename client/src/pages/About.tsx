  ...
  return (
    <div className="about-v2 board-page--makeover">
      ...
      <section id="submit-an-idea" className="about-v2-ideas" aria-labelledby="about-ideas-title"><ScrollReveal><div className="about-v2__inner about-v2-ideas__grid">
        ...
        {ideaStatus === "sent" ? <div className="about-v2-ideas__sent pdx-glass-rebind" role="status"><strong>Idea received.</strong><span>Thank you for helping build what Portland needs next.</span><Button type="button" variant="neon" accent="lime" size="md" onClick={() => setIdeaStatus("idle")}>Send another idea</Button></div> :
