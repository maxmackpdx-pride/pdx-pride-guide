...
export default function Sellz() {
  ...
  return <div className="zine-page board-page board-page--makeover sellz-page">
    <ZBoardAddressStrip path="sellz" board="SELLZ" />
