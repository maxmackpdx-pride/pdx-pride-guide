  ...
  useEffect(() => {
    ...
    const attach = () => {
      ...
      const syncSheet = () => {
        ...
        sheetOpen = open;
        window.dispatchEvent(new CustomEvent("zaylist:drawer", { detail: { open, keepCollapsedOnClose: true } }));
      };
