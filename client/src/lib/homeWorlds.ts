...
export type WorldSpec = {
  ...
  mark: string | null;
  slot: WorldSlotKind;
  promoLines: [string, string, string];
  mapLayer?: string;
};
...
export const WORLDS: WorldSpec[] = [
  {
    ...
    body: "Oregon outside, mapped for queer people who actually want to go there.",
    action: "Explore OutZide",
    href: "/outzide",
    accent: "var(--neon-orange, #ff6600)",
    mark: "/brand/outzide.png",
    slot: "promo",
    promoLines: ["Beaches, trails and campouts", "Live check-ins and group chats", "Built for getting off the feed"],
  },
  {
    key: "eventz",
    number: "02",
    ...
    body: "Portland queer nightlife without digging through six different social feeds.",
    action: "Find an event",
    href: "/events",
    accent: "var(--neon-cyan, #00ffff)",
    mark: "/brand/family/eventz.png",
    slot: "promo",
    promoLines: ["Tonight, this weekend and beyond", "Real flyers from local organizers", "Save it, share it, show up"],
  },
  {
    key: "placez",
    number: "03",
    ...
    body: "Find the places that show up for Portland's queer community.",
    action: "See PlaceZ on the map",
    href: "/map?layer=places",
    accent: "var(--panel-cyan, #19e3ff)",
    mark: "/brand/family/our-placez.svg",
    slot: "promo",
    promoLines: ["Queer-owned and queer-friendly", "Bars, food, shops and services", "Know exactly where to go"],
    mapLayer: "PlaceZ",
  },
  {
    key: "hauz",
    ...
    body: "Find the room, roommate, home, or people that fit your actual life.",
    action: "See HouZ on the map",
    href: "/map?layer=houz",
    accent: "var(--panel-cyan, #19e3ff)",
    mark: "/brand/family/the-hauz.svg",
    slot: "promo",
    promoLines: ["Rooms and homes available", "Roommates looking for people", "New households forming together"],
    mapLayer: "HouZ",
  },
  {
    key: "giftz",
    ...
    body: "Give what you have. Ask for what you need. Keep useful stuff in the community.",
    action: "See GiftZ on the map",
    href: "/map?layer=giftz",
    accent: "var(--board-gifting, #ccff00)",
    mark: "/brand/family/giftz.svg",
    slot: "promo",
    promoLines: ["Always free, never a marketplace", "Offer items or ask for help", "Local handoffs without the weirdness"],
    mapLayer: "GiftZ",
  },
  {
    key: "gigz",
    ...
    body: "Find paid work or hire queer talent without feeding a corporate job board.",
    action: "See GigZ on the map",
    href: "/map?layer=gigz",
    accent: "var(--board-gigs, #6e3dff)",
    mark: "/brand/family/gigz.svg",
    slot: "promo",
    promoLines: ["Local gigs and remote work", "Post what you need or what you do", "Talent already connected to the scene"],
    mapLayer: "GigZ",
  },
  {
    key: "sellz",
    ...
    body: "Buy and sell locally with people who are already part of the community.",
    action: "See SellZ on the map",
    href: "/map?layer=sellz",
    accent: "var(--neon-green, #39ff14)",
    mark: "/brand/family/sellz.svg",
    slot: "promo",
    promoLines: ["Straightforward local listings", "Real people and nearby handoffs", "Less marketplace bullshit"],
    mapLayer: "SellZ",
  },
  {
    key: "mizzed",
    ...
    body: "For the person you saw, felt, and cannot stop thinking about.",
    action: "See Mizzed on the map",
    href: "/map?layer=mizzed",
    accent: "var(--board-spotted, #ff00cc)",
    mark: "/brand/family/mizzed-connection.svg",
    slot: "promo",
    promoLines: ["Post where the moment happened", "Private replies by default", "Consent before connection"],
    mapLayer: "Mizzed",
  },
  {
    key: "zspace",
    ...
    body: "Community spaces built for conversation, plans, and people instead of engagement metrics.",
    action: "Find your community",
    href: "/z",
    accent: "var(--panel-cyan, #19e3ff)",
    mark: null,
    slot: "promo",
    promoLines: ["Groups made by local people", "Conversation without the algorithm", "Make plans that leave the screen"],
  },
];
