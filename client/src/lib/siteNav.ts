...
export const PRIMARY_NAV: NavEntry[] = [
  ...
  { type: "link", href: "/directory", label: "Placez", accent: "blue" },
  {
    ...
    /*
     * z/out is a real index page, so "All OUTZ" leads the list the same way
     * "All Eventz" does. Below it are the only two OUTZ addresses there are.
     */
    items: [
