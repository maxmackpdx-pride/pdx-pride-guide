...
3. **Request to join / invite** — people request in, or the Lead invites; requests open a conversation, they don't auto-add. Note: **request to join is a distinct action from request to chat** (§12). Chat is talking / feeling it out with no commitment; join is asking to become a member of the household. Someone can chat without ever requesting to join, and vice-versa — don't collapse them into one action.
