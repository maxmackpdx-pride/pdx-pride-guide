...
- **Geofence to the Portland metro.** The scraper filters to the metro (same spirit as the directory map lock) so a PM with statewide inventory doesn't flood the board with out-of-area units.
