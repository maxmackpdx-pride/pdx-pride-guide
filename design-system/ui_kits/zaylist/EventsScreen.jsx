...
function EventsScreen({ data, saved, onSave, onRsvp, onNav, onOpen }) {
    ...
    <div className="pg-events">
      ...
      <div className="pg-container">
        <section style={{ paddingBlock: "var(--space-16) var(--space-10)" }}>
          <span className="pdx-marker">Portland's queer events, all in one place</span>
          ...
          <p style={{ maxWidth: "52ch", marginTop: 14, color: "var(--text-mid)", fontSize: "var(--body-lg)" }}>
            Every queer party, parade, show, and gathering in Portland, all in one place.
          </p>
          <div style={{ marginTop: 22 }}>
            <EvBtn accent="lime" arrow onClick={() => onNav && onNav("schedule")}>View as Schedule</EvBtn>
          </div>
        </section>
      </div>
