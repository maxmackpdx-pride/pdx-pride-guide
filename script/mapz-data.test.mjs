...
test('live waypoint updates preserve coordinates and remove filtered-out pins',async()=>{
 const context=vm.createContext({Map,Set,Intl,Date,Promise,setTimeout,console,
  dataGeneration:0,typeIcons:new Map(),baseColors:['#00FFFF'],adultVenueColor:'#FF0000',ensureLightSprite(){},paletteKey:'',hologramMaterials:{dispose(){}},createHologramMaterials:()=>({dispose(){}}),selectedKey:null,phases:new Map(),sequence:0,waypointHeightScale:()=>1,createSpatialIndex:()=>()=>[],surfaceCache:new WeakMap(),map:{getCenter:()=>({lng:-122.676,lat:45.523})},assetsReady:false,lightFeatures:[],nearbyLights:null,updateSceneStatus(){},scheduleFrame(){},loadVenueLogo:async()=>{},disposed:false,
 });
