...
assert(blDrafts[0]?.ageRequirement === "21_PLUS", "Badlands is 21+ bar (never ALL_AGES)");
assert(blDrafts[0]?.admission !== "FREE", "Badlands does not invent FREE cover");
assert(blDrafts[0]?.admission === "UNKNOWN", "Badlands unknown cover → UNKNOWN not FREE");
